...
export const SKILLS_DIR = ".gptloop/skills";
 ...
 * them onto disk inside the workspace's ".gptloop/skills" directory.
 */
...
class SkillRunner {
  ...
  /**
   * Ensure the ".gptloop/skills" directory exists under `filePath`, then write each requested skill's
